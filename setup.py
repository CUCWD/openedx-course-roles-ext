#!/usr/bin/env python
"""
Package metadata for openedx_course_roles_ext.
"""
import os
import re
import sys
...
VERSION = get_version('openedx_course_roles_ext', '__init__.py')
...
setup(
    name='openedx-course-roles-ext',
    version=VERSION,
    description="""Handles course role permissions separately from the platform code.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Zachary Trabookis',
    author_email='ztraboo@clemson.edu',
    url='https://github.com/CUCWD/openedx-course-roles-ext',
    packages=find_packages(
        include=['openedx_course_roles_ext', 'openedx_course_roles_ext.*'],
        exclude=["*tests"],
    ),
