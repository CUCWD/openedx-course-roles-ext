...
"""
openedx-course-roles-ext documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-course-roles-ext',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/CUCWD/openedx-course-roles-ext",
...
#
# html_title = 'openedx-course-roles-ext v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Handles course role permissions separately from the platform code.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_course_roles_ext'),
                os.path.join(root_path, 'openedx_course_roles_ext/migrations')])
